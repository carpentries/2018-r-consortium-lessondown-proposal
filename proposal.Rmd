...
* Weeks 4-19: 4 cycles of 4 weeks, with tests of the package on an increasing number of lessons at each cycle.
    ...
    - week d: implement changes
        ...
        + For weeks 4-7: We'll work on the [Data Carpentry R Ecology lesson](http://www.datacarpentry.org/R-ecology-lesson).
        ...
        + For weeks 12-15: We'll convert and test `lessondown` on  our Geospatial and Genomics Curricula.
  
        + For weeks 16-19: We'll convert and test `lessondown` on all "The Carpentries" lessons.
